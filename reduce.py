...
popularProducts[1].append(
    "Instead of using toilet papers from trees use bamboo toilet paper such as bumboo or even better use a bidet to totally reduce this source of paper watse")
...
popularProducts[5].append(
    "Reduces the energy used to build those items and Co2 to ship them, ensures old items dont go to waste")
...
popularProducts[7].append(
    "Plastic accounts for roughly 25% of the teabag. By switching to loose leaf you will reduce the amount of plastic ending up in landfills")
